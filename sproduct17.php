    ...
    <section id="header">
     ...
     <section id="diya" class="section-p1">
        <div class="single-pro-image">
            <img src="image/d25.jpg" width="100%" id="MainImg" alt="">
        </div>

        <div class="single-pro-details">
            <h4>Women Solid, Self Design Kruti</h4>
            <h2>₹500</h2>
            <select name="Dress">
     ...
     <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            <div class="pro">
                ...
                <div class="des" onclick="window.location.href='sproduct18.php';">
            ...
            <div class="pro">
                ...
                <div class="des" onclick="window.location.href='sproduct6.php';">
                    <span>DC collections</span>
                    <h5>Choies Blue Polka Dot Flounce Hem 3/4 Sleeve Chiffon Shirt</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
            ...
            <div class="pro">
                ...
                <div class="des" onclick="window.location.href='sproduct5.php';">
                    <span>DC collections</span>
                    <h5>Choies Blue Polka Dot Flounce Hem 3/4 Sleeve Chiffon Shirt</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
            ...
            <div class="pro">
                ...
                <div class="des" onclick="window.location.href='sproduct7.php';">
                    <span>DC collections</span>
                    <h5>Choies Blue Polka Dot Flounce Hem 3/4 Sleeve Chiffon Shirt</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
