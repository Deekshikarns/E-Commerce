...
<html lang="en">
    ...
    <section id="about-head" class="section-p1">
        <img src="image/e6.jpg" alt="">
        <div>
            <h2>Who We Are?</h2>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor odio numquam facilis non consectetur, iure nam enim, voluptatum dolore optio quibusdam qui accusantium atque deleniti consequatur, fugiat porro! Aliquam velit, delectus necessitatibus vel, facilis suscipit perspiciatis assumenda blanditiis molestias illum nesciunt quidem cupiditate quis. Delectus impedit sit dolorem nulla soluta?</p>
    ...
    <section id="about-app" class="section-p1">
        ...
        <div class="video">
            <video autoplay muted loop src="image/1.mp4"></video>
        </div>
    </section>
