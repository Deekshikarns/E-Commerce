    ...
    <section id="header">
     ...
     <section id="diya" class="section-p1">
        <div class="single-pro-image">
            <img src="image/d22.jpg" width="100%" id="MainImg" alt="">
        </div>
     ...
     <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            ...
            <div class="pro">
                <img src="image/dress23.jpg" alt="">
                <div class="des" onclick="window.location.href='sproduct22.php';">
                    <span>DC collections</span>
                    <h5>Choies Blue Polka Dot Flounce Hem 3/4 Sleeve Chiffon Shirt</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
            ...
            <div class="pro">
                <img src="image/dress24.jpg" alt="">
                <div class="des" onclick="window.location.href='sproduct23.php';">
                    <span>DC collections</span>
                    <h5>Choies Blue Polka Dot Flounce Hem 3/4 Sleeve Chiffon Shirt</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
