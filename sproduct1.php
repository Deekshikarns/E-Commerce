    ...
    <section id="header">
     ...
     <section id="diya" class="section-p1">
        <div class="single-pro-image">
            <img src="image/dress9.jpg" width="100%" id="MainImg" alt="">
        </div>

        <div class="single-pro-details">
            <h4>Women Solid, Self Design Denim Jacket</h4>
            <h2>₹1000</h2>
            <select name="Dress">
            ...
            Style code: KD-0@3-DRK-DHGA-MOTI-JKT<br/> 
           Ideal for: Women<br/> 
           Sleeve: Full Sleeve<br/>
           Net Quantity (N) : 1<br/>   
           Pack of : 1<br/>
           STYLISH AND STUNNING DENIM JACKET .ITS FULL SLEEVES <br/>
           JACKET.DOUBLE POCKET WITH REGULAR COLLAR MONKEY<br/>
           WASH STONE ROUGH JACKET.ITS DAILY USE TO WEAR .IT <br/>
           CAN BE WORN ON RIDING BIKE.YOU CAN WEAR DARK OR LIGHT<br/>
           COLOR T-SHIRT.ALL SIZES AVAIL .FOR THAT YOU CAN WATCH<br/>
           SIZE CHART FOR YOUR COMFORT .DON'T BE BOTHER TO BUY THIS<br/>
           BEAUTIFUL JACKET.AFTER BUYING GIVE UR VALUABLE FEEDBACK .<br/>     
     ...
     <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            <div class="pro">
                ...
                <div class="des" onclick="window.location.href='sproduct16.php';">
            ...
            <div class="pro">
                ...
                <div class="des" onclick="window.location.href='sproduct20.php';">
                    <span>DC collections</span>
                    <h5>Choies Blue Polka Dot Flounce Hem 3/4 Sleeve Chiffon Shirt</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
            ...
            <div class="pro">
                ...
                <div class="des" onclick="window.location.href='sproduct24.php';">
                    <span>DC collections</span>
                    <h5>Choies Blue Polka Dot Flounce Hem 3/4 Sleeve Chiffon Shirt</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
            ...
            <div class="pro">
                ...
                <div class="des" onclick="window.location.href='sproduct4.php';">
                    <span>DC collections</span>
                    <h5>Choies Blue Polka Dot Flounce Hem 3/4 Sleeve Chiffon Shirt</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
